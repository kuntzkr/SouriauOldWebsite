  ...
  <div class="b-product-info full-width">
    <h4>
      <span class="ico <?php print $_data['file_mimetype_class']; ?>" style="width: 20px;height: 20px;float: left;">
        <!--[if gte IE 9]><!-->
          <svg class="svg-ico"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#ico-ipaper"></use></svg>
        <!--<![endif]-->
      </span>
      ...
      <a href="<?php print $_data['file_url']; ?>" data-gtm-category="Download" data-gtm-action="ipaper" data-gtm-label="<?php print $_data['file_title']; ?>" target="_blank">
