 ...
 */
?>
<a class="link <?php if($is_landing): ?>without-text <?php endif ?>link-favourite <?php print $flag_classes ?> <?php print (strstr($flag_classes, 'unflag-action')) ? 'active' : '' ?>" href="<?php print $link_href; ?>">
  <span class="text"><?php print t('Save in favorites', [], ['context' => SOURIAU_COMMON_T_OTHER]); ?></span>
  <?php if(!$is_landing): ?>
