<div class="b-form">
  <form>
    <fieldset>
      <legend>CREATE A NEW ADDRESS</legend>

      <div class="form-item form-type-textfield">
        <label for="name">First name</label>
        <input id="name" class="form-text" type="text" name="name" />
      </div>

      <div class="form-item form-type-textfield">
        <label for="name2">Last name</label>
        <input id="name2" class="form-text" type="text" name="name2" />
      </div>
      ...
      <div class="form-row">
        <div class="form-item form-type-textfield a-left">
          ...
          <input id="zip-code" class="form-text" type="text" name="zip-code" />
        </div>
      ...
      <div class="form-item form-type-textfield">
        ...
        <input id="m-phone" class="form-text" type="text" name="m-phone" />
      </div>
    ...
    <div class="form-block form-actions text-center">
      <div class="align-btn-center">
        <button class="btn orange-btn-hover a-right">ADD THIS ADDRESS</button>
