  ...
  <div class="page">
    ...
    <div class="main-content">
      <div class="category-banner w-banner-block">
        ...
        <div class="b-banner">
          <figure class="pic">
            <img src="images/temp/category-banner.jpg" alt="banner image" />
          </figure>
        </div>
      ...
      <div class="b-category-description grey-bg">
        <div class="container">
          <p>Souriau offers a full range of aluminum backshells and caps. <br>The best choice for a global solution provider.
          </p>
        </div>
      </div>

      <?php include "inc/blocks/block-sub-category-group.php"; ?>
