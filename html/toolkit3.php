  ...
  <div class="page">
    ...
    <div class="main-content">
      <div class="w-breadcrumb show-share">
        <div class="container">
          ...
          <div class="breadcrumb">
            <ul>
              <li><a href="#">HOME</a></li>
              <li class="without-link">TOOLKIT</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="b-form">
            <form>
              <div class="b-two-cols">
                <div class="column a-left">
                  <div class="box">
                    ...
                    <div class="form-item form-type-textfield">
                      <label for="name2">Competitor Part Number</label>
                      <input id="name2" class="form-text" value="" name="name2" type="text">
                    </div>                  <div class="form-item form-type-textfield">
                      <label for="name2">Competitor Part Number</label>
                      <input id="name2" class="form-text" value="" name="name2" type="text">
                    </div>                  <div class="form-item form-type-textfield">
                      <label for="name2">Competitor Part Number</label>
                    ...
                    <div class="form-block form-actions text-center">
                      <button class="btn blue-btn">FIND A MATCH</button>
                    </div>
                  </div>
                ...
                <div class="column a-right">
                  <div class="box">
                    <h2>Title</h2>
                    <div class="form-item form-type-textfield">
                      <label for="name3">Competitor Part Number</label>
      ...
      <div class="grey-bg with-border">
        <div class="b-results">
          <div class="container">
            <h4>We found a matching product for you PNXXXXXX</h4>
            <p>
              Please contact us for more information on this product:
            </p>
            <div class="w-btn">
              <a href="contact.php" class="btn orange-btn-hover">CONTACT US</a>
            </div>
