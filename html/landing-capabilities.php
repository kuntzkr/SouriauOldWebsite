...
<body>
  ...
  <div class="page">
    ...
    <div class="main-content">
      <div class="w-banner-block landing-cap-banner">
        <div class="w-breadcrumb show-share">
          <div class="container">
            ...
            <div class="breadcrumb b-white">
              <ul>
                <li><a href="#">HOME</a></li>
                <li class="without-link">CAPABILITIES</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="b-banner">
          <figure class="pic">
            <img src="images/temp/landing-cap-banner.jpg" alt="banner image" />
          </figure>
        </div>
      </div>
      ...
      <?php include "inc/blocks/block-application4.php"; ?>
